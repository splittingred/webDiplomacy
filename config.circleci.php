...
class Config
{
	 ...
	 * @var string
	 */
	public static $database_name='webdiplomacy_test';
	 ...
	 * @var string
	 */
	public static $salt = 'donotusethisinproduction';
	 ...
	 * @var string
	 */
	public static $secret='donotusethisinproduction';
	 ...
	 * @var string
	 */
	public static $gameMasterSecret='password';
	 ...
	 * @var string
	 */
	public static $jsonSecret='password';
	 ...
	 * @var string
	 */
	public static $adminEMail='diplomacy@theroomandboard.com';
	 ...
	 * @var string
	 */
	public static $modEMail='diplomacy@theroomandboard.com';
	...
	public static $mailerConfig = array(
			"From"=> "diplomacy@theroomandboard.com",
	 ...
	 */
	public static $downtimeTriggerMinutes = 15;

	public static $url = 'http://test.webdiplomacy.net';
